 ...
 *
 * Authors: Michael DuBois, David Farmer, Rob Beezer, Jahrme Risner
 *
 *******************************************************************************
 */
...
window.addEventListener("load", function(event) {
    ...
    // If you click a knowl in an aside, the 'front' stays the same because it toggles twice.
...
;(function($, w, Espy, undefined) {
    ...
    var Mathbook = function(options) {
        var defaults = {
            ...
            // linear feels mechanical, but we do not want to load jquery.ui.easing
        ...
        // But do not allow namespaced options to be overwritten
        // Extend them instead
        var property;
        ...
        self.postMathJax = function() {
            ...
            // TODO expand knowl from hash if there is a match?
        };
        /**
        ...
        self.initializeStickies = function() {
            ...
            if (hasSidebarLeft) {
                ...
                // If primaryNavbar is top, offset sidebar by its height,
                // else offset zero
        ...
        self.reconfigureEspy = function() {
            ...
            // To be safe, do not allow negative
        ...
        self.onSectionStateChange = function(isEntered, state) {
            ...
            // do not update links during auto scrolls
        ...
        // hash so that the page does not jump as we change the hash
        // It is sort of expensive, so do not call it needlessly
        ...
        self.hasSidebarLeft = function() {
            // To be safe, we will require everything
        ...
        /**
         * Locks the main element at its current width
         */
        ...
        self.resize = function() {
            ...
            var isSidebarOpen = !self.isSidebarLeftClosed() || !self.isSidebarRightClosed();
         ...
         * events and we do not want to slow down the resize by doing this stuff
         */
